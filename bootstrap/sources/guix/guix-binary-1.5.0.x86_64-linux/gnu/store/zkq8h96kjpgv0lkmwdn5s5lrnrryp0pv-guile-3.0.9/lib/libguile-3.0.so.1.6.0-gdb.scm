...
(set! %load-path
  (cons "/gnu/store/zkq8h96kjpgv0lkmwdn5s5lrnrryp0pv-guile-3.0.9/share/guile/3.0" %load-path))
(set! %load-compiled-path
  (cons "/gnu/store/zkq8h96kjpgv0lkmwdn5s5lrnrryp0pv-guile-3.0.9/lib/guile/3.0/site-ccache" %load-compiled-path))
