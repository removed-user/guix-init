...
(unless (getenv "GUILE_SSH_CROSS_COMPILING")
  (load-extension "/gnu/store/m2ysynx4wd8rp7cij0y5v9fmjyb0qvf4-guile-ssh-0.18.0/lib/libguile-ssh" "init_sftp_session")
  (load-extension "/gnu/store/m2ysynx4wd8rp7cij0y5v9fmjyb0qvf4-guile-ssh-0.18.0/lib/libguile-ssh" "init_sftp_file")
  (load-extension "/gnu/store/m2ysynx4wd8rp7cij0y5v9fmjyb0qvf4-guile-ssh-0.18.0/lib/libguile-ssh" "init_sftp_dir"))
